...
> [!NOTE]
> This notes are written using [typst](https://github.com/typst/typst). I use [tinymist](https://github.com/Myriad-Dreamin/tinymist) as an integrated LSP service. Inside `conf.typ` there's the base template for my notes for an arbitrary course.

## AI DISCLOSURE

These notes (and configurations in typst) are _NOT_ AI generated but are minimally targeted for what I needed.
